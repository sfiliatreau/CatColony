...
<html lang="en">
  ...
  <head>
    ...
    <?PHP
        ...
        function displayData()
        {
            ...
            //$db = new mysqli('localhost', 'root', 'mysql', 'prjdbf'); //local
            $db = new mysqli('us-cdbr-east-05.cleardb.net', 'bceaf6f174ba2d', 'f5b37b09', 'heroku_177b596c63864ca'); //prod
  ...
  <body>
    ...
    <h2>My Incremental Workflow</h2>
      ...
      <h2>My ERD</h2>
      <img src="graphic/prjDBFDesign.png" alt="ERD for this page">
    
    </main>

    <footer>
    <p><small>Sarah Howard | CSC 235 | prjDBF | 2022.03.27</small></p>
    </footer>
